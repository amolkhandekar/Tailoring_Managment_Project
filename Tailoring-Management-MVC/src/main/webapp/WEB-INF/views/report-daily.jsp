    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="content-wrapper">
                <h3 class="mb-4">Daily Orders Report</h3>

                <!-- Filter Section -->
                <div class="filter-section">
                    <form method="get" action="${pageContext.request.contextPath}/dailyreport" class="d-flex flex-wrap gap-3">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty orders}">
                                <tr>
                                    <td colspan="8" class="text-center text-muted">No orders found for this date</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
